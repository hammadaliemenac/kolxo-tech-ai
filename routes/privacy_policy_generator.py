...
def read_item(request: PrivacyPolicyRequest):
    ...
    prompt += f"Please write the privacy policy in clear and formal {request.content_language} language, ensuring that it includes necessary data protection clauses and complies with relevant laws like GDPR and CCPA. The response should be in simple text format without any HTML tags or formatting."
